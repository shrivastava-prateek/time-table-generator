											...
											<div class="form-group ">
												...
												<div class="col-lg-10">
													<form:input path="batch_venue" class=" form-control"
														...
														<font color="red"><form:errors path="batch_venue"/></font>
												</div>
											</div>
											<div class="form-group ">
											...
											<div class="form-group ">
												...
												<div class="col-lg-10">
													<form:input path="no_of_cand" class="form-control "
														id=" total_count" type="number" min="1" required="" />
														<font color="red"><form:errors path="no_of_cand"/></font>
												</div>
											</div>
											<div class="form-group ">
