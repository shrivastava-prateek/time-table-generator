								...
								<div class="panel-body">
									...
									<div class=" form">
										...
										<form:form modelAttribute="batch"
											...
											method="post" action="downloadPDF" novalidate="novalidate">
												...
												<div class="col-lg-10">
													<form:select path="batch_name" class="form-control">
														...
														<form:option style="color: black;"
															value="<%=batch.getBatch_name()%>" id="f" required="">
															<%
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class=" form">
										<form:form modelAttribute="batch"
											class="cmxform form-horizontal tasi-form" id="signupForm"
											method="post" action="downloadExcel" novalidate="novalidate">
											<div class="form-group ">
												<label for="batch_name" class="control-label col-lg-2">Batch
													Name </label>
												...
												<div class="col-lg-10">
													<form:select path="batch_name" class="form-control">
														<%-- //<form:option style="color: black;" value="0" id="f" required=""> Select a Batch</form:option> --%>
											...
											<font color="red"><form:errors path="batch_name" /></font>
											<div class="col-md-4"></div>
