		...
		<div class="topbar">
			...
			<div class="topbar-left">
				<div class="text-center">
					<a href="" class="logo"><img><span></span><span>TT
							Generator </span></a>
				</div>
			</div>
						...
						<div class="col-sm-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h3 class="panel-title">Enter the User</h3>
								</div>
								<div class="panel-body">
									...
									<div class=" form">
										...
										<form:form modelAttribute="user"
											class="cmxform form-horizontal tasi-form" method="post"
											action="del_user_1" novalidate="novalidate">
											<div class="form-group ">
												<label for="abc" class="control-label col-lg-2">User
													Name </label>

												<div class="col-lg-10">
													<%
														UserDao udao = (UserDao) request.getAttribute("udao");
															List<User> userlist = udao.getAllUsers();
													%>


													<form:select path="username" class="form-control">
														<%-- <form:option style="color: black;" value="0" id="f"> Select a User</form:option> --%>
