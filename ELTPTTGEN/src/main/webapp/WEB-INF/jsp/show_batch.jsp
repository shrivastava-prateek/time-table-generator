...
<%@page import="com.bean.Batch_type"%>
...
<body class="fixed-left" onload="func1('<%=type1%>')">
						...
						<div class="col-sm-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h3 class="panel-title">Batch Details</h3>
								</div>
	...
	Batch_type type;%>
										<%
											Integer id = (Integer) request.getAttribute("val2");
											int a = id.intValue();
											...
											for (Batch vt : batch_list) {
												if (vt.getBatch_id() == a) {
													name = vt.getBatch_name();
													venue = vt.getBatch_venue();
													type = vt.getBatch_type();
													candidate = vt.getNo_of_cand();
													city = vt.getBatch_city();
													date = vt.getStart_date();
													break;
												}
										...
										<form:form modelAttribute="show"
											...
											method="post" action="add_batch_1" novalidate="novalidate">
											...
											<div class="form-group ">
												<label for="lastname" class="control-label col-lg-2">Type
													:<%
													out.println(type);
												%>
												</label>
											...
											<div class="form-group ">
												<label for="username" class="control-label col-lg-2">Candidates
													:<%
											...
											<div class="form-group ">
												<label for="username" class="control-label col-lg-2">City
													:<%
													out.println(city);
												%>
												</label>
